...
const Tip_2: Tips = {
  site: 'Dewey',
  content: `
    The 201 bus doesn't come at the best times, but it is the most convenient bus. 
...
const Tip_8: Tips = {
    site: "Kingsley",
    content: "(unrelated to b&b) but if u have time after, central street is so underrated (highly rec hewn & backlot coffee for a lil sweet treat)",
}
...
const Tip_10: Tips = {
    site: "Lincoln",
    content: 
    `The entrance is tucked away, past the playgrounds and near the garden beds. 
...
const Tip_11: Tips = {
    site: "Lincolnwood",
    content: "It’s in a gym which means there’s a lot of open space for the kids to run around so it’s a bit chaotic ",
}

const Tip_12: Tips = {
    site: "Walker",
    content: `
    Tutors at walker uber there in the mornings (the only site allowed for this since it would be unreasonable to get there via public transportation). 
...
const Tip_14: Tips = {
    site: "Walker",
    content: "Fridays we have the art teacher Ms. Sam and we usually play basketball Fridays too. Most kids will try to get around reading in their various creative ways so we sometimes need to insist on getting the brainwork done but after focusing them in it’s not usually an issue. ",
}

const Tip_15: Tips = {
    site: "Walker",
    content: `
    don't be afraid to communicate with Nimrah and the other tutors, everyone is super nice and wants to help out! 
...
const Tip_16: Tips = {
    site: "Washington",
    content: `
    Show up early! Kids start arriving usually around 7:50am. 
